<script>
  ...
  <div class="flex items-center justify-between p-2">
    <div class="flex items-center space-x-3">
      <div class="w-12 h-12" style="background: repeating-linear-gradient(
    45deg,
    ...
    var(--color-pkd-cream-2) 8px
      ...
      <div class="flex flex-col justify-center items-start">
        ...
        <p class="pt-1 font-pokemon text-xs text-pkd-ink pb-1">{pokemon.name.toUpperCase()}</p>
      </div>
    </div>

    <button
      class="w-14 h-14 transition cursor-pointer"
